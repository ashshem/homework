...
# Bug: this function needs to be able to be turned off when one pixel
# in the image reaches either black or white. If pixels that had once
# been different colors are then changed into either completely white
# or completely black, rendering them the same, they will never be
# able to be changed back to their original state by means of this
# same fucntion
...
# the light and dark functions implement the intensity functions
# defined above
...
# l: raises the intensity of each pixel in the image by 10 units
...
# d: darkens the intensity of each pixel in the image by 10 units
