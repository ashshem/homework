...
##s = State()
##print(s.setImage) #method = function thats a member of a class that
                    #takes an instance of that class as an argument
                    #implicitly
##s.setImage(initImage) #because we specified s. at the begining, s is passed
                        #implicitly into setImage, and we do not include it in
                        #the parenthasies

ooInitState = State(initImage)
...
# define in this file.
#
rw.runWorld(ooInitState, updateState, updateDisplay, endState, frameRate, handleMouseDown, None, handleKeyDown, None, None)
